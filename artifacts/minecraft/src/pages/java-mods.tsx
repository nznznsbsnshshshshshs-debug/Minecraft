    ...
    <div className="min-h-screen bg-black text-white pb-24">
      <div className="relative overflow-hidden px-5 pt-12 pb-8">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <p className="text-zinc-400 text-sm">Futuristic Java Edition mods, shaders, textures, and gameplay upgrades.</p>
        </div>
      </div>
      ...
      <div className="px-5 max-w-2xl mx-auto">
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-zinc-400">No Java mods uploaded yet.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
